                ...
                data.forEach(product => {
                    if (!seenBatchIds.has(product.batch_id)) {
                        ...
                        rows += `<tr>
                            ...
                            <td><div class="">${product.user_id}</td></div>
                            <td><div class="">${formattedDate}</td></div>
                            <td><div class="">${batchAmounts[product.batch_id]}</td></div> <!-- Total amount -->
                            <td><div class="">${batchPending[product.batch_id] || 0}</td></div>
                            <td><div class="">${batchInprogressTotals[product.batch_id] || 0}</td></div> <!-- Total inprogress count -->
                            <td><div class="">${batchComplete[product.batch_id] || 0}</td></div>
                            <td><div class="">${batchCancelled[product.batch_id] || 0}</td></div>
                            <td><div class="">${overallStatus}</td></div>
                        </tr>`;
                    }
                });
